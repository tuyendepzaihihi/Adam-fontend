...
import { HeadCell, UserAdminInteface } from "../../contant/IntefaceContaint";
...
const headCells: HeadCell<UserAdminInteface>[] = [
  {
    id: "id",
    numeric: false,
    disablePadding: true,
...
export default function UserScreen() {
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const newSelecteds = rows_example_user.map((n) => n.id);
      ...
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(rows_example_user, getComparator(order, orderBy))
